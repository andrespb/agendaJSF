...
public class Tactividad  implements java.io.Serializable {
    ...
    public Tactividad(String codigoActividad, Tusuario tusuario, String nombre, String descripcion, Date fechaInicio, Date fechaFin, BigDecimal presupuestoTotal, char estado, Date fechaRegistro, Date fechaModificacion, Set tactividadcomentarios, Set tactividadparticipantes, Set tactividadpresupuestos) {
       this.codigoActividad = codigoActividad;
       this.tusuario = tusuario;
       this.nombre = nombre;
       this.descripcion = descripcion;
